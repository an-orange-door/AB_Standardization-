...
<style>
  .bg{fill:#FAFAF8}
  .wall{fill:none;stroke:#2F4B7C;stroke-width:2.6;stroke-linecap:round}
  .corner{fill:none;stroke:#8A6A16;stroke-width:2.6;stroke-linecap:round}
  .corner.reflex{stroke:#9C4A2F}
  .cdot{fill:#8A6A16}
  .cdot.reflexdot{fill:#9C4A2F}
  .lbl{font-size:8.5px;fill:#2F4B7C;text-anchor:middle;font-weight:700}
  .cmp{font-size:7.5px;fill:#5F656C;text-anchor:middle}
  .origin{font-size:8.5px;fill:#1A1D21;font-weight:700}
  .title{font-size:13px;font-weight:700;fill:#1A1D21}
  .meta{font-size:10.5px;fill:#5F656C;font-family:ui-monospace,Consolas,monospace}
  .h1{font-size:19px;font-weight:700;fill:#1A1D21}
  .h2{font-size:12px;fill:#5F656C}
  .key{font-size:11px}
</style>
