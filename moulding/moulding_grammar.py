...
<style>
  .bg{fill:#F7F9FB}
  .prof{fill:#111820;stroke:#111820;stroke-width:.6;stroke-linejoin:round}
  .wall{stroke:#15679E;stroke-width:1;stroke-dasharray:3 3;opacity:.65}
  .cat{font-size:12px;font-weight:700;letter-spacing:.09em;fill:#5A6875}
  .code{font-size:11px;font-weight:700;fill:#111820}
  .dim{font-size:10.5px;fill:#5A6875;font-family:ui-monospace,Consolas,monospace}
  .sub{font-size:10px;fill:#8A9AA8}
  .approx{fill:#96650F;font-weight:700}
  .t{font-size:17px;font-weight:700;fill:#111820}
  .s{font-size:11.5px;fill:#5A6875}
</style>
